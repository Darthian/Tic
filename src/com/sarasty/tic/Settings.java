...
public class Settings extends PreferenceActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final EditTextPreference prefsVictory = (EditTextPreference) findPreference("victory_message");
		String victoryString = prefs.getString("victory_message", getResources().getString(R.string.result_human_wins));
		prefsVictory.setSummary((CharSequence) victoryString);
		prefsVictory.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
					@Override
					public boolean onPreferenceChange(Preference preference,
							Object newValue) {
						difficultyLevelPref.setSummary((CharSequence) newValue);
